...
if __name__ == '__main__':
    ...
    generate_routefile(sumo_files_path=sumo_files_path, rou_xml_filename=route_file_name, num_seconds=num_seconds, \
        create_new_vehicle_prob=create_new_vehicle_prob, random_seed=random_seed, straight_prob=0.8)
    sumocfg_path = generate_sumocfg(sumo_files_path, route_file_name)
