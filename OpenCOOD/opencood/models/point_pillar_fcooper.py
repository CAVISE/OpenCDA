"""
PointPillar with F-Cooper for multi-agent collaborative 3D object detection.

This module implements PointPillar architecture integrated with F-Cooper spatial fusion
...
class PointPillarFCooper(nn.Module):
    ...
    spatial fusion for efficient multi-agent cooperative perception.
    ...
    fusion_net : SpatialFusion
        F-Cooper spatial fusion module for multi-agent feature fusion.
    cls_head : nn.Conv2d
