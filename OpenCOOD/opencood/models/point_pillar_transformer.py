"""
PointPillar with Transformer for multi-agent collaborative 3D object detection.

This module implements PointPillar architecture integrated with Transformer-based
fusion for multi-agent cooperative perception with efficient feature sharing.
"""
...
class PointPillarTransformer(nn.Module):
    ...
    This model combines PointPillar architecture with Transformer-based fusion mechanism
    to enable multi-agent cooperative perception through attention-based feature aggregation.
    ...
    args : dict of str to Any
        ...
        - 'transformer': Configuration for V2XTransformer fusion.
    ...
    fusion_net : V2XTransformer
        Transformer-based fusion module for multi-agent feature fusion.
    cls_head : nn.Conv2d
    ...
    def forward(self, data_dict: Dict[str, Any]) -> Dict[str, torch.Tensor]:
        ...
        data_dict : dict of str to Any
            ...
            - 'prior_encoding': Prior encoding with shape (B, max_cav, 3, 1, 1) containing
              temporal delay, velocity, and infrastructure information.
