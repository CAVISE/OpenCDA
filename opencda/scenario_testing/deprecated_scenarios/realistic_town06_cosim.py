...
import opencda.scenario_testing.utils.cosim_api as cosim_api
...
def init(opt, scenario_params) -> None:
    ...
    scenario_manager = cosim_api.CoScenarioManager(
        scenario_params,
        opt.apply_ml,
        opt.version,
        town='Town06',
...
def run() -> None:
    global eval_manager, scenario_manager, single_cav_list, rsu_list, spectator
