...
def run_scenario(opt, scenario_params):
    try:
        ...
        sumo_cfg = os.path.expanduser('~/artery/scenarios/realistic_town06_cosim')
        scenario_manager = \
        ...
        eval_manager = EvaluationManager(scenario_manager.cav_world, script_name='single_2lanefree_cosim', current_time=scenario_params['current_time'])
