        ...
        for attack in self.active_attacks:
            if attack["tick"] == tick_number:
                ...
                if attack["attack_type"].startswith("lidar_remove"):
                    modified_data = self._apply_lidar_remove_attack(modified_data, attack_module, attack)
                elif attack["attack_type"].startswith("lidar_spoof"):
                    modified_data = self._apply_lidar_spoof_attack(modified_data, attack_module, attack)
                elif attack["attack_type"] == "adv_shape":
                    modified_data = self._apply_adv_shape_attack(modified_data, attack_module, attack)
