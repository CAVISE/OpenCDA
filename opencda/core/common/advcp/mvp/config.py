...
class_id_map = {0: "unlabeled", 1: "car", 2: "truck", 3: "person", 4: "bicycle", 5: "other"}

class_id_inv_map = {"unlabeled": 0, "car": 1, "truck": 2, "person": 3, "bicycle": 4, "other": 5}

color_map = {0: [255, 255, 255], 1: [255, 0, 0], 2: [255, 200, 200], 3: [0, 255, 0], 4: [0, 0, 255], 5: [0, 0, 0]}
