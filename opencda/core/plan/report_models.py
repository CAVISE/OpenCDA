"""
Structured data models for planning metric collection and reporting.
"""
...
@dataclass(frozen=True, slots=True)
class PlanningActorReport:
    """Structured planning report for a single actor."""
...
@dataclass(frozen=True, slots=True)
class PlanningModuleReport:
    """Structured planning report for all evaluated actors."""

    module: str
    actors: tuple[PlanningActorReport, ...]
