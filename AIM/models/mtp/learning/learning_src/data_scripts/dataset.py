...
from AIM.models.mtp.learning.learning_src.data_scripts.preprocess_utils import rotation_matrix_with_allign_to_X
    ...
    def process(self) -> None:
        ...
        for preprocess_subfolder in preprocess_subfolders:
            ...
            for file in tqdm(preprocess_files):
                ...
                rotation_matrixes = rotation_matrix_with_allign_to_X(data[0][:, 3:4])
                ...
                x_data_skip = data[0].unsqueeze(0)[:, :, 4:].repeat(data[0].shape[0], 1, 1)
                x_data = torch.cat([x_data_coords, x_data_speed, x_data_yaw, x_data_skip], dim=-1)
